...
class RadioTileStyle
    with _$RadioTileStyle
    implements ThemeExtension<RadioTileStyle> {
  ...
  @override
  RadioTileStyle lerp(RadioTileStyle? other, double t) => RadioTileStyle(
        ...
        selectedShape:
            ShapeBorder.lerp(selectedShape, other?.selectedShape, t)!,
